...
class EBVConv2d(nn.Module):
    def __init__(self, t, ebv_dict, conv):
        super().__init__()
...
@HEADS.register_module()
class EBVMaskHead(FCNMaskHead):

    def __init__(self, ebv_dim=81, t=0.07, ebv_dict=None, *args, **kwargs):
        super().__init__(*args, **kwargs)
        conv = build_conv_layer(self.predictor_cfg, self.conv_out_channels, ebv_dim, 1)
        self.conv_logits = EBVConv2d(t, ebv_dict[:self.num_classes], conv)
